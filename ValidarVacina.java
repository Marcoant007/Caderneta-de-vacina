...
public class ValidarVacina extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (action.equals("cadastrar")) {
            ...
            vac.setDoses(request.getParameter("txtDose"));
            vac.setPrimeiradose(request.getParameter("txtPrimeiraDose"));
          ...
          request.getRequestDispatcher("sucessovacina.jsp").forward(request, response);
