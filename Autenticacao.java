...
public class Autenticacao extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (login.equals("Harland@gmail.com") && senha.equals("123456")) {
            //setando um atributo dentro da sessao
            sessao.setAttribute("usuario", login);
            //Para encerrar uma sessao 
            //  sessao.removeAttribute("usuario");
            //  sessao.invalidate();
            String nome = sessao.getAttribute("usuario").toString();
            System.out.println("Sessao: "+nome);
            System.out.println("Sessao: "+sessao.getAttribute("usuario"));
