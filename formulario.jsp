                ...
                <div class="wrap-login100 p-t-190 p-b-30">
                    <form method="post" id="FormCad" name="FormCad" action="ValidarForm">
                        ...
                        <div class="wrap-input100 validate-input m-b-10">
                            ...
                            <input type="text" name="txtSUS" id="cartao_sus" placeholder="Digite o número do Cartão SUS" class="input100" required >
                            <span class="focus-input100"></span>
                            <span class="symbol-input100">
                        ...
                        <div class="wrap-input100 validate-input m-b-10">
                            ...
                            <input type="text" name="txtRegistro" id="registro_civil" placeholder="Digite o número do Registro Civil" class="input100" required >
                            <span class="focus-input100"></span>
                            <span class="symbol-input100">
