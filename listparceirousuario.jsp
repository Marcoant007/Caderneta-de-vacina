...
<html class="no-js" lang="zxx">
    ...
    <head>
        ...
        <title>Caderneta de Vacina Online</title>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="bradcam_text">
                            <h3>Parceiros</h3>
                            <p><a href="index.jsp">Menu /</a> contact</p>
                        </div>
                    </div>
                </div>
            </div>
        </div>
        <div class="expert_doctors_area" style="background: white;">
                    <div class="container">
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="doctors_title mb-55">
                                    <h2>Faça parte do nosso quadro de Parceiros <span><i  style="color: #007bff"class="fa fa-thumbs-o-up" aria-hidden="true"></i></span></h2>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                ...
                                <div class="expert_active owl-carousel">
                                    <div class="single_expert">
                                        <div class="expert_thumb">
                                            <img src="img/experts/logo1.png" alt="">
                                        </div>
                                    ...
                                    <div class="single_expert">
                                        <div class="expert_thumb">
                                            <img src="img/experts/logo2.png" alt="">
                                        </div>
                                        <div class="experts_name text-center">
                                            <h3>Med Sênior</h3>
                                            <span>Centro médico</span>
                                    ...
                                    <div class="single_expert">
                                        <div class="expert_thumb">
                                            <img src="img/experts/logo3.jpg" alt="">
                                        </div>
                                        <div class="experts_name text-center">
                                            <h3>UPA 24h</h3>
                                            <span>Unidade de pronto Atendimento</span>
                                        </div>
                                    </div>
                                    <div class="single_expert">
                                        <div class="expert_thumb">
                                            <img src="img/experts/hospital infatil.png" alt="">
                                        </div>
                                        <div class="experts_name text-center">
                                            <h3>Hospital Las Californias</h3>
                                            <span>Hospital Infântil</span>
                                        </div>
                                    </div>
                                    <div class="single_expert">
                                        <div class="expert_thumb">
                                            <img src="img/experts/senac.png" alt="">
                                        </div>
                                        <div class="experts_name text-center">
                                            <h3>Senac</h3>
                    ...
                    <div class="col-lg-3 offset-lg-1">
                        <div class="media contact-info">
                            ...
                            <div class="media-body">
                                <h3>Espirito Santo Vitória</h3>
                                <p>Resultados da pesquisa
                                    Av. Mal. Mascarenhas de Moraes, 2077 - Bento Ferreira, Vitória - ES, 29050-625</p>
                            </div>
                        </div>
                        <div class="media contact-info">
                            ...
                            <div class="media-body">
                                <h3>27 988740756</h3>
                                <p>Segunda a sexta 08h / 17h</p>
                            </div>
                        </div>
                        <div class="media contact-info">
                            <span class="contact-info__icon"><i class="ti-email"></i></span>
                            <div class="media-body">
                                <h3>marcoantnovo@gmail.com</h3>
                                <p>Nos envie seu feedback, pedido de parceria, reclamações</p>
                            </div>
                        </div>
                    </div>
                </div>
